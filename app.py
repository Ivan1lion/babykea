...
from aiogram.types import Message, SuccessfulPayment, ContentType
...
from handlers.for_user import for_user_router, successful_payment
...
async def main():
    ...
    dp.message.register(successful_payment, F.successful_payment) #проверка успешного платежа
